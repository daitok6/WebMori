...
function ShopifyLogo({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 109 124" fill="currentColor" aria-label="Shopify">
...
function WordPressLogo({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 122 122" fill="currentColor" aria-label="WordPress">
