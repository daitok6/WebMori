...
export function buildEmail(body: string): string {
  ...
  <table width="100%" cellpadding="0" cellspacing="0" style="max-width:600px;margin:auto;">
    <tr>
      <td style="background:${NAVY};padding:24px 32px;border-radius:8px 8px 0 0;">
        <span style="color:${GOLD};font-size:20px;font-weight:bold;">Web<span style="color:white;">Mori</span></span>
      </td>
    </tr>
    <tr>
...
export function buildParagraph(greeting: string, content: string): string {
  return `<p style="margin:0 0 16px;color:${NAVY};font-size:16px;">${esc(greeting)}</p>
  ...
  <p style="margin:24px 0 0;color:${TEXT_MUTED};font-size:13px;">
    WebMori（ウェブ守り）<br>
    <a href="https://webmori.jp" style="color:${GOLD};">webmori.jp</a>
  </p>`;
}
