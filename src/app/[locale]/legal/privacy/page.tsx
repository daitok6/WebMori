      ...
      <div className="mx-auto max-w-3xl px-6">
        ...
        <div className="mt-10 space-y-8 text-ink leading-relaxed">
          {isJa ? (
            <>
              <section>
                <h2 className="text-xl font-semibold text-ink mb-3">1. 事業者情報</h2>
                <p>WebMori（ウェブ守り）は、ウェブセキュリティ監査サービスを提供する事業者です。本プライバシーポリシーは、当サービスが収集・利用する個人情報の取り扱いについて説明します。</p>
              </section>

              <section>
                <h2 className="text-xl font-semibold text-ink mb-3">2. 収集する情報</h2>
              ...
              <section>
                <h2 className="text-xl font-semibold text-ink mb-3">3. 情報の利用目的</h2>
              ...
              <section>
                <h2 className="text-xl font-semibold text-ink mb-3">4. 第三者への提供</h2>
              ...
              <section>
                <h2 className="text-xl font-semibold text-ink mb-3">5. データの保持期間</h2>
                <p>アカウントデータはサービス利用中および解約後90日間保持します。お支払い履歴は法令に従い7年間保持します。削除をご希望の場合はお問い合わせください。</p>
              </section>

              <section>
                <h2 className="text-xl font-semibold text-ink mb-3">6. セキュリティ</h2>
                <p>SSL/TLS暗号化、アクセス制御、定期的なセキュリティレビューにより、お客様の情報を保護します。ただし、インターネット上での完全な安全性を保証するものではありません。</p>
              </section>

              <section>
                <h2 className="text-xl font-semibold text-ink mb-3">7. お客様の権利</h2>
                <p>お客様は以下の権利を有します：個人情報の開示・訂正・削除の請求、利用停止の請求。ご要望はお問い合わせページよりご連絡ください。</p>
              </section>

              <section>
                <h2 className="text-xl font-semibold text-ink mb-3">8. Cookieの使用</h2>
                <p>当サービスはセッション管理のためにCookieを使用します。ブラウザの設定によりCookieを無効化できますが、一部機能が利用できなくなる場合があります。</p>
              </section>

              <section>
                <h2 className="text-xl font-semibold text-ink mb-3">9. ポリシーの変更</h2>
                <p>本ポリシーを変更する場合は、このページにて通知します。重要な変更はメールでもお知らせします。</p>
              </section>

              <section>
                <h2 className="text-xl font-semibold text-ink mb-3">10. お問い合わせ</h2>
                <p>プライバシーに関するご質問は、<a href="/contact" className="text-primary hover:underline">お問い合わせページ</a>よりご連絡ください。</p>
              </section>
            </>
          ) : (
            <>
              <section>
                <h2 className="text-xl font-semibold text-ink mb-3">1. About Us</h2>
              ...
              <section>
                <h2 className="text-xl font-semibold text-ink mb-3">3. How We Use Information</h2>
                <ul className="list-disc pl-6 space-y-1">
              ...
              <section>
                <h2 className="text-xl font-semibold text-ink mb-3">4. Third Parties</h2>
              ...
              <section>
                <h2 className="text-xl font-semibold text-ink mb-3">6. Security</h2>
              ...
              <section>
                ...
                <p>For privacy-related questions, please reach us via our <a href="/contact" className="text-primary hover:underline">contact page</a>.</p>
              </section>
            </>
          )}
        </div>
