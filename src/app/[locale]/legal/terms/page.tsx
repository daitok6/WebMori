      ...
      <div className="mx-auto max-w-3xl px-6">
        ...
        <div className="mt-10 space-y-8 text-text-body leading-relaxed">
          {isJa ? (
            <>
              <section>
                <h2 className="text-xl font-semibold text-navy-dark mb-3">第1条（適用）</h2>
                <p>本利用規約（以下「本規約」）は、WebMori（ウェブ守り）（以下「当社」）が提供するウェブセキュリティ監査サービス（以下「本サービス」）の利用条件を定めるものです。利用者は本規約に同意した上で本サービスをご利用ください。</p>
              </section>

              <section>
                <h2 className="text-xl font-semibold text-navy-dark mb-3">第2条（利用登録）</h2>
              ...
              <section>
                <h2 className="text-xl font-semibold text-navy-dark mb-3">第6条（知的財産権）</h2>
                <p>本サービスおよび監査レポートに含まれる著作権その他の知的財産権は当社に帰属します。利用者は、業務上の利用（社内共有・改善実施等）の範囲でレポートを使用することができます。</p>
              </section>

              <section>
                <h2 className="text-xl font-semibold text-navy-dark mb-3">第7条（免責事項）</h2>
                <p>当社は本サービスによる監査が全ての脆弱性・問題を発見することを保証しません。当社の提案に基づく修正の実施はお客様の判断・責任において行われます。当社の賠償責任は、当該月の利用料金を上限とします。</p>
              </section>

              <section>
                <h2 className="text-xl font-semibold text-navy-dark mb-3">第8条（サービスの変更・停止）</h2>
                <p>当社はサービス内容を予告なく変更・停止することがあります。重要な変更については事前に通知します。</p>
              </section>

              <section>
                <h2 className="text-xl font-semibold text-navy-dark mb-3">第9条（準拠法・管轄）</h2>
                <p>本規約は日本法に準拠します。本サービスに関する紛争は、東京地方裁判所を第一審の専属的合意管轄裁判所とします。</p>
              </section>

              <section>
                <h2 className="text-xl font-semibold text-navy-dark mb-3">第10条（お問い合わせ）</h2>
                <p>本規約に関するお問い合わせは、<a href="/contact" className="text-gold hover:underline">お問い合わせページ</a>よりご連絡ください。</p>
              </section>
            </>
          ) : (
            <>
              <section>
                <h2 className="text-xl font-semibold text-navy-dark mb-3">1. Acceptance of Terms</h2>
              ...
              <section>
                <h2 className="text-xl font-semibold text-navy-dark mb-3">2. Account Registration</h2>
              ...
              <section>
                <h2 className="text-xl font-semibold text-navy-dark mb-3">3. Fees and Payment</h2>
              ...
              <section>
                <h2 className="text-xl font-semibold text-navy-dark mb-3">4. Cancellation and Refunds</h2>
              ...
              <section>
                <h2 className="text-xl font-semibold text-navy-dark mb-3">5. Prohibited Activities</h2>
              ...
              <section>
                <h2 className="text-xl font-semibold text-navy-dark mb-3">6. Intellectual Property</h2>
              ...
              <section>
                <h2 className="text-xl font-semibold text-navy-dark mb-3">7. Disclaimer</h2>
              ...
              <section>
                <h2 className="text-xl font-semibold text-navy-dark mb-3">8. Service Changes</h2>
                <p>We may modify or discontinue the Service at any time. We will provide advance notice of significant changes.</p>
              </section>

              <section>
                <h2 className="text-xl font-semibold text-navy-dark mb-3">9. Governing Law</h2>
              ...
              <section>
                ...
                <p>For questions about these Terms, please reach us via our <a href="/contact" className="text-gold hover:underline">contact page</a>.</p>
              </section>
            </>
          )}
        </div>
