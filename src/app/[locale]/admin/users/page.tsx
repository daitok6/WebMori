    ...
    <>
      ...
      <div className="mt-4 flex gap-3">
        <div className="relative flex-1 max-w-xs">
          ...
          <input
            ...
            className="w-full rounded-lg border border-border bg-white pl-9 pr-3 py-2 text-sm focus:border-gold focus:outline-none focus:ring-1 focus:ring-gold"
          />
        </div>
        <select
          value={planFilter}
          onChange={(e) => setPlanFilter(e.target.value)}
          className="rounded-lg border border-border bg-white px-3 py-2 text-sm focus:border-gold focus:outline-none"
        >
      ...
      {loading ? (
        ...
        <Card className="mt-6 py-12 text-center">
          <User className="mx-auto mb-3 h-8 w-8 text-text-muted" />
              ...
              <Card className="hover:shadow-md transition-shadow cursor-pointer pr-12">
                ...
                {u.org && (
                  <div className="mt-2 ml-13 pl-13">
                    <p className="text-xs text-text-muted ml-[52px]">
                      {u.org.name}
